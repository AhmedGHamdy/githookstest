...
// Set Variables
$LOCAL_ROOT         = "/opt/tomcat7_addtest/webapps/Add-Pluses/githookstest";
$LOCAL_REPO_NAME    = "githookstest";
$LOCAL_REPO         = "{$/opt/tomcat7_addtest/webapps/Add-Pluses}/{$githookstest}";
